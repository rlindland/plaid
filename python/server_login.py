...
def index():
  return render_template(
    'index_login.html', access_token_str=access_token, item_id_str = item_id
  )
...
def get_access_token():
  ...
  # #added
  # exchange_response['access_token'] = "access-sandbox-e1d41dff-4d13-4367-a0af-20c49a7be88b"
  # exchange_response['item_id'] = "vxkA3kXN4KuAnkLpRQRMtmq16akKMxuqjgL5Z"
  # print("ADDED:")
  # pretty_print_response(exchange_response)
  # access_token = exchange_response['access_token']
  # item_id = exchange_response['item_id']
